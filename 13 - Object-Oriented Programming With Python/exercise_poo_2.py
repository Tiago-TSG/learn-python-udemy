...
from exercise_poo_1 import Pessoa
...
if __name__ == '__main__':
    ...
    agenda.buscar_contato('Felicity Jones') # 0
    agenda.buscar_contato('Ray Sychev') # 2
    
    print("----------------------------------------------------------------------------------------------------")
    agenda.imprimir_contato(2) # Ray Sychev
    agenda.remover_contato(contato3) # Ray Sychev
